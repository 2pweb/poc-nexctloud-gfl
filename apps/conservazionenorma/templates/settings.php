...
<div class="followupsection">
   <form autocomplete="false" action="#"
      ...
      <input type="text" name="username" autocomplete="false" value="<?php p($_['globalCredentials']['user']); ?>" placeholder="Username"/>
      <input type="password" name="password" autocomplete="false" value="<?php p($_['globalCredentials']['password']); ?>" placeholder="Password"/>
      <input type="hidden" name="uid" value="<?php p($_['globalCredentialsUid']); ?>"/>
